              ...
              <div className="prose prose-slate max-w-none space-y-8 mt-6">
                ...
                <CollapsibleSection title="الباب الثاني - الجمعيات ذات النفع العام">
                  <div className="space-y-4">
                    ...
                    <div className="bg-primary/5 p-4 rounded-lg">
                      <p><span className="font-bold text-primary">مادة 43-</span> تتمتع الجمعية ذات النفع العام بقدر من امتيازات السلطة العامة يحدد بقرار من رئيس الجمهورية، وبوجه خاص:</p>
                      <ul className="list-disc list-inside mt-2 space-y-1 text-sm">
                        <li>عدم جواز الحجز على أموالها كلها أو بعضها.</li>
                        <li>عدم جواز تملك هذه الأموال بالتقادم.</li>
                        <li>جواز نزع الملكية للمنفعة العامة لصالحها.</li>
                      </ul>
                    </div>
                    <div className="bg-primary/5 p-4 rounded-lg">
                      <p><span className="font-bold text-primary">مادة 44-</span> تخضع الجمعيات ذات النفع العام لرقابة الجهة الإدارية المختصة، وتتناول هذه الرقابة فحص أعمال الجمعية والتحقق من مطابقتها للقوانين ولنظام الجمعية وقرارات الهيئة العامة، وتبين اللائحة التنفيذية كيفية ممارسة هذه الرقابة.</p>
                    </div>
                    <div className="bg-primary/5 p-4 rounded-lg">
                      <p><span className="font-bold text-primary">مادة 45-</span> للجهة الإدارية المختصة أن تنشئ في منطقة ما اتحاداً لغرض تنسيق نشاط الجمعيات ذات النفع العام التي تكون أغراضها متماثلة أو متقاربة، أو لغرض توحيد مصادر أموالها وتوزيعها على أوجه نشاطها، ويتألف هذا الاتحاد من ممثلي هذه الجمعيات ومن ممثلي فروع الوزارات والمصالح العامة ذات الصلة وأشخاص آخرين يصدر بتعيينهم قرار من الوزير المختص.</p>
                    </div>
                    <div className="bg-primary/5 p-4 rounded-lg">
                      <p><span className="font-bold text-primary">مادة 46-</span> يجوز للجهة الإدارية المختصة أن تقرر إدماج أكثر من جمعية من الجمعيات ذات النفع العام إذا كانت تسعى لتحقيق غرض مشترك أو لتوحيد إدارتها أو لتعديل أغراضها تبعاً لما تقتضيه احتياجات البيئة أو تحقيقاً للتناسق بين الخدمات التي تؤديها أو لأي سبب آخر تراه كفيلاً بحسن تحقيق الغرض الذي أنشئت من أجله، ويصدر قرار الإدماج مسبباً وتبين فيه كيفية الإدماج وآثاره.</p>
                    </div>
                    <div className="bg-primary/5 p-4 rounded-lg">
                      <p><span className="font-bold text-primary">مادة 47-</span> يجوز للجهة الإدارية المختصة أن تقرر تعيين مدير أو مجلس إدارة مؤقت للجمعية ذات النفع العام يتولى الاختصاصات المقررة في نظامها للمدير أو لمجلس الإدارة، وذلك إذا وقعت من الجمعية مخالفات لأحكام هذا القانون أو لنظامها الأساسي أو إذا عجزت عن تحقيق أغراضها.</p>
                    </div>
                    <div className="bg-primary/5 p-4 rounded-lg">
                      <p><span className="font-bold text-primary">مادة 48-</span> على المدير أو مجلس الإدارة المؤقت أن يدعو الهيئة العامة للانعقاد خلال المدة التي يحددها قرار التعيين، وأن يعرض عليها تقريراً مفصلاً عن حالة الجمعية، وتنتخب الهيئة العامة في هذا الاجتماع مجلس إدارة جديداً وتنتهي بذلك مهمة المدير أو مجلس الإدارة المؤقت.</p>
                    </div>
                    <div className="bg-primary/5 p-4 rounded-lg">
                      <p><span className="font-bold text-primary">مادة 49-</span> يجوز للجهة الإدارية المختصة أن تطلب من مجلس إدارة الجمعية ذات النفع العام استبعاد أي مرشح لعضوية المجلس أو أي موظف في الجمعية إذا رأت في ذلك مصلحة عامة، ولذوي الشأن التظلم من هذا القرار وفقاً للأحكام المقررة في المادة /11/ من هذا القانون.</p>
                    </div>
                    <div className="bg-primary/5 p-4 rounded-lg">
                      <p><span className="font-bold text-primary">مادة 50-</span> لا يجوز لموظفي الجهة الإدارية المختصة الذين يتولون الرقابة على الجمعيات ذات النفع العام أن يشتركوا في عضوية مجالس إدارتها إلا إذا كان ذلك بناءً على نص خاص في القانون أو بقرار من الوزير المختص.</p>
                    </div>
                    <div className="bg-primary/5 p-4 rounded-lg">
