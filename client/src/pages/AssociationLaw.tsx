              ...
              <div className="prose prose-slate max-w-none space-y-8 mt-6">
                ...
                <CollapsibleSection title="الباب الثاني - الجمعيات ذات النفع العام">
                  <div className="space-y-4">
                    ...
                    <div className="bg-primary/5 p-4 rounded-lg">
                      <p><span className="font-bold text-primary">مادة 43-</span> يعين بقرار من رئيس الجمهورية مدا تتمتدع بده الجمعيدة ذات النفدع العدام مدن اختصاصدات
                      السلطة العامة كعةم جواع الحجع على موالها كلها و بعضدها و كدذلف عدةم جدواع تملدف هدذه ا مدوال
                      بمضي المة و جواع يام الجهة ا ةارية المختصة بنعع الملكية للمنفعة العامة التي تقوم بها الجمعية.</p>
                    </div>
                    <div className="bg-primary/5 p-4 rounded-lg">
                    ...
                    <div className="bg-primary/5 p-4 rounded-lg">
                      <p><span className="font-bold text-primary">مادة 48-</span> للجمعيدة ذات

                      و مجلدس إةار من تداً

                      مادة 48 - للجهدة ا ةارية المختصة ن تعين بقرار مسبب مةيراً
                      النفع العام يتولى االختصاصات المخولة في نظامها لمجلس إةارتها وذلف إذا ارتكبت من المخالفدات مدا
                      يستوجب هدذا ا جراء ولم تر الجهة ا ةارية حلها و و إذا صبدح عةة عضداء مجلس ا ةار ال يكفدي
                      النعقاةه انعقاةا و وإذا تعذر انعقاة الهيئة العامدة بسدبب عدةم تكامدل ا عضداء مدرتين متدواليتين ً صحيحاً
                      بةون عذر تقبله الجهة ا ةاريدة المختصة وذلف كله بعة إنذار الجمعية بذعالة سباب المخالفة وانقضداء
                      خمسة عشر يوما من تداري ا ندذار ةون إعالتهدا. ) و ينشدر القدرار الصداةر بهدذا الشدأن فدي الجريدة ً
                      ية المختصة ن تصةر حكما ذا ا جراء بنداء علدى طلدب ي عضدو مدن ً الرسمية (. وللمحكمة االبتةائ به
                      عضاء الجمعية و ي شخص ذي مصلحة .</p>
                    </div>
                    <div className="bg-primary/5 p-4 rounded-lg">
                      <p><span className="font-bold text-primary">مادة 49-</span> يجوز للجهة الإدارية المختصة أن تطلب من مجلسعلى عضاء مجلس إةار الجمعية و الموظفين القائمين بالعمدل فيهدا ن يبداةروا إلدى تسدليم
                        المجلس المن ت بمجرة تشكيله جميع موال الجمعية وسجالتها وةفاترها ومستنةاتها وال يخل هذا التسليم
                        ب حكام القانون .</p>
                    </div>
                    <div className="bg-primary/5 p-4 rounded-lg">
                      <p><span className="font-bold text-primary">مادة 50-</span> 
                        على المةيدر و مجلس ا ةار المن ت ن يةعو الهيئة العامة خلال المة التي يحدةةها درار
                        تعينه و ن يعر ض عليها تقريراً مفصلاً عن حالتها و تنتخب الهيئدة العامدة مجلدس إةارتهدا الجةيدة فدي
                        الجلسة ذاتهدا بع ة اتخداذ ا جراءات الخاصدة بترشيح عضاء مجلس ا ةار وفقا حكام هدذا القدانون و
                        وتكون رارات المةير و المجلس المن دت خدلال المدة المعيندة فدي درار تشدكيله ملعمدة للجمعيدة فدي
                        الحةوة المبينة بهذا القرار و في الحةوة المقرر في نظام الجمعية .
                      </p>
                    </div>
                    <div className="bg-primary/5 p-4 rounded-lg">
                      <p><span className="font-bold text-primary">مادة 51-</span> للجهة الإدارية المختصة أن تقرر حرمان من تثبت مسؤوليتهم من أعضاء مجلس الإدارة القديم عن وقوع المخالفات التي دعت إلى تعيين مدير أو مجلس إدارة مؤقت من ترشيح أنفسهم لعضوية مجلس الإدارة الجديد لمدة أقصاها ثلاث سنوات.</p>
                    </div>
                  </div>
                </CollapsibleSection>
