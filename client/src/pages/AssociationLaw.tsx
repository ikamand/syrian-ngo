                  ...
                  <div className="space-y-4">
                    <div className="bg-primary/5 p-4 rounded-lg">
                      ...
                      <ul className="list-decimal list-inside mt-2 space-y-2 pr-4 text-sm">
                        ...
                        <br> 
                          ولا يجوع حل الجمعيات فدي الحدالات / 1
                          ا نذار ةون ن تستجب الجمعية له على ن لا تقل فتر ا نذار عن خمسة عشر يوما .
                          ب- يعتبر رار حل الجمعية طعي ا لا يقبل ي طريق من طر المراجعة .
                          ج- في جميدع الحالات يجب ن يستنة رار الحل إلدى تحقيقدات رسدمية تجريهدا الدةوائر المختصدة فدي
                          . )1969 /9 / وعار الشنون الاجتماعية والعمل. ) عةلت هذه الماة بالمرسوم ر م 224 تاري 21
                        </br>
                        </li>
                        <li>ممارسة الجمعية نشاطا يمس الأخلاق والآداب العامة .</li>
                        <li>ممارسة الجمعية نشاطا يمس الأخلاق والآداب العامة .</li>
