              ...
              <div className="prose prose-slate max-w-none space-y-8">
                <section>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-primary/5 p-4 rounded-lg">
                      <p><span className="font-bold text-primary">مادة 25-</span> للجمعية أن تكون فروعاً لها، ويجوز شهر هذه الفروع ويكون لها حينئذ شخصية اعتبارية مستقلة على أن لا يكون للفرع تعديل نظامه الداخلي فيما يتعلق بالالتزامات قبل الجمعية الأصلية وكذلك فيما يتعلق بالسياسة العامة والتوجيه إلا بموافقة الجمعية الأصلية.</p>
                    </div>
                  </div>
                </section>
