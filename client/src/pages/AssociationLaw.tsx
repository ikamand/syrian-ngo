                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-primary/5 p-4 rounded-lg">
                      ...
                      <ul className="list-disc list-inside mt-2 space-y-1 text-sm">
                        ...
                        <li>عدم جواز نزع ملكيتها للمنفعة العامة.</li>
                      </ul>
                    </div>
                    <div className="bg-primary/5 p-4 rounded-lg">
                      <p><span className="font-bold text-primary">مادة 44-</span> تخضع الجمعيات ذات النفع العام لرقابة الجهة الإدارية المختصة، وتتناول هذه الرقابة فحص أعمال الجمعية والتحقق من مطابقتها للقوانين ولنظام الجمعية وقرارات الهيئة العامة، وللوزير أن يندب مفتشين للقيام بهذه الرقابة.</p>
                    </div>
                    <div className="bg-primary/5 p-4 rounded-lg">
                      <p><span className="font-bold text-primary">مادة 45-</span> للجهة الإدارية المختصة أن تنشئ في منطقة ما اتحاداً لغرض تنسيق نشاط الجمعيات ذات النفع العام التي تكون أغراضها متماثلة أو متقاربة، أو لغرض توحيد مصادر أموالها وتوزيعها على أوجه نشاطها، ويتألف هذا الاتحاد من ممثلي هذه الجمعيات ومن ممثلي فروع الجهات الإدارية المختصة وأشخاص آخرين يصدر بتعيينهم قرار من الوزير المختص.</p>
                    </div>
                    <div className="bg-primary/5 p-4 rounded-lg">
