              ...
              <div className="prose prose-slate max-w-none space-y-8 mt-6">
                ...
                <CollapsibleSection title="الباب الثاني - الجمعيات ذات النفع العام">
                  <div className="space-y-4">
                    ...
                    <div className="bg-primary/5 p-4 rounded-lg">
                      <p><span className="font-bold text-primary">مادة 43-</span> يعين بقرار من رئيس الجمهورية ما تتمتع به الجمعية ذات النفع العام من اختصاصات السلطة العامة مثل:</p>
                      <ul className="list-disc list-inside mt-2 space-y-1 text-sm">
                        <li>عدم جواز الحجز على أموالها كلها أو بعضها.</li>
                        <li>عدم جواز تملك هذه الأموال بمضي المدة.</li>
                        <li>جواز قيام الجهة الإدارية المختصة بنزع الملكية للمنفعة العامة التي تقوم بها الجمعية.</li>
                      </ul>
                    </div>
                    <div className="bg-primary/5 p-4 rounded-lg">
